...
@section('content')
    <h1 class="mb-4">Радактирование блюда</h1>
    <form action="{{ route('dishes.update', $dish) }}" method="post" id="form-store-menu">
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="composition" id="composition" value="{{ $dish->composition }}">
            </div>
        </div>
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input type="number" class="form-control" name="weight" id="weight" min="0" step="10" value="{{ $dish->weight }}" aria-describedby="basic-addon-weight">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input type="number" class="form-control" name="price" id="price" min="0" step="0.1" value="{{ $dish->price }}"  aria-describedby="basic-addon-price">
...
@push('scripts')
    <script type="text/javascript">
        $('#form-store-menu').on('submit', function () {
            ...
            $.ajax({
                type: 'put',
                url: '{{ route('dishes.update', ['id' => $dish->id]) }}',
                data: $(this).serialize(),
                success: function (e) {
